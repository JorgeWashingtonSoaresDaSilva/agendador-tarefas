...
import com.jwss.studio.agendadortarefas.business.mapper.TarefasUpdateConverter;
   ...
   public List<TarefasDTO> buscaTarefasPorEmail(String token){
    ...
    public void deletarTarefaPorId(String id){
        ...
        try {
            ...
            throw new ResourceNotFoundExcepition("Erro ao deletar tarefa por id, id inexistente," + id,
                    e.getCause());
        }
    }
